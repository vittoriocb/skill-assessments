...
```{r SECTION 1 Q1.3, fig.width=20, fig.height=12}
df %>%
...
kable(tidy(model_base), caption = "Linear regression (log transformed) terms")
kable(glance(model_base), caption = "Linear regression (log transformed) statistics")
...
Average population density varies greatly (**`r range_format(df_pop$AvgPopDensity)`**). The top 2 countries with the highest `'Population density (people per sq. km of land area)'` across all years are **`r top_countries`**.   
